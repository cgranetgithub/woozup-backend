...
class ResourcesTestCase(TestCase):
    def setUp(self):
        ...
        # create relations
        Link.objects.create(sender=self.u1, sender_status='ACC',
                            receiver=self.u2, receiver_status='ACC')
        Link.objects.create(sender=self.u1, sender_status='ACC',
                            receiver=self.u3, receiver_status='ACC')
        Link.objects.create(sender=self.u2, sender_status='ACC',
                            receiver=self.u4, receiver_status='ACC')
        # create categorie & type
        cat = EventCategory.objects.create(name="meal")
        etype = EventType.objects.create(name="meal")
        etype.category.add(cat)
        # create some events for u1
        e1 = Event.objects.create(owner=self.u1, event_type=etype,
                                  start=timezone.now(),
                                  name="u1 breakfast",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2 = Event.objects.create(owner=self.u1, event_type=etype,
                                  start=timezone.now(),
                                  name="u1 lunch",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2.participants.add(self.u2)
        e3 = Event.objects.create(owner=self.u1, event_type=etype,
                                  start=timezone.now(),
                                  name="u1 diner",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        ...
        e1 = Event.objects.create(owner=self.u2, event_type=etype,
                                  start=timezone.now(),
                                  name="u2 breakfast",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2 = Event.objects.create(owner=self.u2, event_type=etype,
                                  start=timezone.now(),
                                  name="u2 lunch",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2.invitees.add(self.u1)
        e2.participants.add(self.u1)
        e3 = Event.objects.create(owner=self.u2, event_type=etype,
                                  start=timezone.now(),
                                  name="u2 diner",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        ...
        e1 = Event.objects.create(owner=self.u3, event_type=etype,
                                  start=timezone.now(),
                                  name="u3 breakfast",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2 = Event.objects.create(owner=self.u3, event_type=etype,
                                  start=timezone.now(),
                                  name="u3 lunch",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2.participants.add(self.u1)
        # create some events for u4
        e1 = Event.objects.create(owner=self.u4, event_type=etype,
                                  start=timezone.now(),
                                  name="u4 breakfast",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2 = Event.objects.create(owner=self.u4, event_type=etype,
                                  start=timezone.now(),
                                  name="u4 lunch",
                                  location_coords='{ "type": "Point", "coordinates": [50.0, 50.0] }')
        e2.participants.add(self.u2)
